    ...
    $.extend($.fn, {
        selectBox: function (method, data) {
            ...
            var showMenu = function (select) {
                ...
                options.css({
                    top: 50 - (parseInt(control.css('borderBottomWidth'))),
