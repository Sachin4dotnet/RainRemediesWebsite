...
Partial Class Home2
    ...
    Private Sub SendMail(ByVal mailsub As String)
        ...
        mailBody = "<div style=""font: 15px trebuchet ms, Calibri, arial; width: 100%; margin: 20px; background-color: #e7e7e7; "">"
        mailBody += "<br><br>"
        mailBody += mailsub
        mailBody += "<br><br>"
        mailBody += "Regards,....<br><br>"
        mailBody += "Rain Remedies"
        ...
        Dim fromAddress = New MailAddress("sac4temp@gmail.com", "Rain Remedies")
        Dim toAddress = New MailAddress("sachin.patel@devitpl.com", "Sachin")
        Const fromPassword As String = "sac$temp"
        Const subject As String = "Subject"
        Const body As String = "Body"
        ...
        'Dim smtp = New SmtpClient() With { _
        '	Key .Host = "smtp.gmail.com", _
        '	Key .Port = 587, _
        '	Key .EnableSsl = True, _
        '	Key .DeliveryMethod = SmtpDeliveryMethod.Network, _
        '	Key .UseDefaultCredentials = False, _
        '	Key .Credentials = New NetworkCredential(fromAddress.Address, fromPassword) _
        '}
